...
os.environ['OPENAI_API_KEY'] = "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"

# Connect to the database and execute the SQL script
conn = sqlite3.connect('C:\\Users\\emm14\\OneDrive\\Desktop\\ChatGPT-Tabular-Data\\Chinook.db')
with open('C:\\Users\\emm14\\OneDrive\\Desktop\\ChatGPT-Tabular-Data\\Chinook_Sqlite.sql', 'r', encoding='cp1252', errors='replace') as f:
    sql_script = f.read()
...
# Create the SQLDatabase and SQLDatabaseToolkit
